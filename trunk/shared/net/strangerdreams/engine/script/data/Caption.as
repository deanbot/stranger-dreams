package net.strangerdreams.engine.script.data
{
	...
	import net.strangerdreams.engine.data.IObjectKeyed;
	import net.strangerdreams.engine.data.IScreened;
	import net.strangerdreams.engine.data.IVersioned;

	public class Caption implements IObjectKeyed, IBaseText, IVersioned, IScreened
	{
		...
		public function Caption(objectKey:String,text:String=null,screens:Dictionary=null,alternateBetweenScreens:Boolean=false,versions:Dictionary=null)
		{
		...
		public function get objectKey():String
		{
			return _objectKey;
		}
